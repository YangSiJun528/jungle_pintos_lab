...
*/
/* 60개의 thread를 시작한다. 각 thread는 10초 동안 sleep한 뒤 60초 동안 tight loop로
   spin하고, 다시 60초 동안 sleep한다. 초기 sleep 이후 main thread는 2초마다 load
   average를 출력한다.

   위 원문 주석에는 예상 출력이 나열되어 있으며, 일부 오차는 허용된다. */
