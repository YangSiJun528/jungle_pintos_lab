/* Create a very deep "vine" of directories: /dir0/dir1/dir2/...
   ...
   for the tar archive. */
/* disk가 가득 찰 때까지 /dir0/dir1/dir2/... 형태의 매우 깊은 directory "vine"과
   각 directory 안의 일반 file을 만든다.

   그런 다음 두 가지 이유로 대부분을 삭제한다. 첫째, "tar"는 file name을 100자로
   제한한다. 이는 큰 어려움 없이 256자로 확장할 수 있다. 둘째, 가득 찬 disk에는
   tar archive를 위한 공간이 없다. */
